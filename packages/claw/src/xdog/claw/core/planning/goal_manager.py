...
from xdog.claw.core.planning.goal_planner import GoalPlanner, _noop_emit
from xdog.claw.core.planning.goal_state_machine import (
    GoalActionKind,
    GoalEvent,
    GoalEventKind,
    GoalStateMachine,
...
class GoalManager:
    ...
    def _start_additional_ready_tasks(self, goal: Goal) -> None:
        ...
        """
        from xdog.claw.core.planning.goal_state_machine import _ready_tasks
        updated = self.tracker.get_goal(goal.id)
        if not updated:
            return

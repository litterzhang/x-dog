...
if TYPE_CHECKING:
    from ai.types import AssistantMessage, Context, StreamOptions
    from ai.utils.event_stream import EventStream


def stream_fn_from_provider(provider: BaseProvider):
...
def web_search_fn_from_provider(provider: BaseProvider, model: str):

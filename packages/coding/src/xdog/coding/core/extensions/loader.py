...
import yaml
from xdog.coding.config import get_extensions_dir
from xdog.coding.core.defaults import EXTENSION_MANIFEST
from xdog.coding.core.extensions.types import Extension, ExtensionHook, ExtensionManifest

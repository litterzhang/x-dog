...
from coding.core.defaults import COMPACTION_THRESHOLD_RATIO, MAX_CONTEXT_TOKENS
...
from coding.core.system_prompt import build_system_prompt
...
class AgentSession:
    ...
    async def _run_compaction(self) -> None:
        ...
        from coding.core.compaction.compaction import compact_messages
